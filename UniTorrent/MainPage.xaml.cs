...
namespace Universal.Torrent.Example
{
    public sealed partial class MainPage
    {
        ...
        public void SuperWriteLine(string onestring)
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs ee)
        {
            ...
            MessageException nException = new Universal.Torrent.Dht.MessageException(ErrorCode.GenericError,"");

            picker.FileTypeFilter.Add(".torrent");
            StorageFile file = await picker.PickSingleFileAsync();
            Stream stream = await file.OpenStreamForReadAsync();

            Common.Torrent torrent = Common.Torrent.Load(stream);
            if (torrent != null)
            {
                var engineSettings = new EngineSettings(ApplicationData.Current.LocalFolder, port)
                {
                ...
                DhtListener dhtListner = new DhtListener(new IPEndPoint(IPAddress.Any, dhtPort));
                ...
                TorrentManager manager = new TorrentManager(torrent, ApplicationData.Current.LocalFolder, torrentDefaults);
                        ...
                        await
                            dispatcher.RunAsync(CoreDispatcherPriority.Normal,
                                () =>
                                {
                                    ...
                                    SuperWriteLine(" >> " + nException.MessageString);
                                });
                    };
            }
        }
